...
import glob
import tqdm
folder_path = "../Data/VoD_picture/image_2/"
#print(folder_path)
outputpath="./output_vod/"
...
for batch_index in range(1966,1980):
    ...
    for path in tqdm.tqdm(batch_paths, disable=not outputpath):
        ...
        for i in range(len(selected_masks)):
            ...
            if class_id_sel == 11:
                ...
                person_cal += 1
            # car bus truck 2
            if class_id_sel == 13 or class_id_sel == 15 or class_id_sel == 14 :
        ...
        if len(selected_masks) == 0:
            selected_masks = torch.zeros(1216,1936)
